...
# Gestión de identidades digitales: fundamentos, open source y cloud


## Plataforma de laboratorios

Te damos la bienvenida a la **plataforma de laboratorios** del curso **Gestión de identidades digitales: fundamentos, open source y cloud**. Aquí podrás explorar diferentes tecnologías a través de prácticas guiadas. ¡Desarrolla tus habilidades y lleva tus conocimientos al siguiente nivel!

Curso para dominar IAM: fundamentos, federación, herramientas open source (Keycloak, OpenIAM), integración con directorios y estrategias BYOD y cloud, con enfoque práctico en implementación y auditoría.
